...
export default function PrivacyMD() {
    return (
        <Container>
            <Container sx={{ mt: 3, fontSize: 14 }}>
                <h1>Privacy Policy for Mood Diary</h1>

                <p>
                    At Devitizen, accessible from www.techj.net,
                    one of our main priorities is the privacy of our visitors.
                    This Privacy Policy document contains types of information
                    that is collected and recorded by Devitizen and how we use
                    it.
                </p>
                ...
                <p>
                    ...
                    information that they shared and/or collect in Devitizen.
                ...
                <p>
                    Devitizen follows a standard procedure of using log files.
                ...
                <p>
                    ...
                    each of the advertising partners of Devitizen.
                </p>
                ...
                <p>
                    ...
                    Devitizen, which are sent directly to users' browser. They
                ...
                <p>
                    Note that Devitizen has no access to or control over these
                ...
                <p>
                    Devitizen's Privacy Policy does not apply to other
                ...
                <p>
                    Devitizen does not knowingly collect any Personal
