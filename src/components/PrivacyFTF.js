...
export default function PrivacyFTF() {
    return (
        <Container>
            <Container sx={{ mt: 3, fontSize: 14 }}>
                <h1>Privacy Policy for Fly to Fruits</h1>
                ...
                <ul>
                    ...
                    <li>
                        <p>
                            ...
                            any electronic device, named Fly to Fruits
                        </p>
                    </li>
                    <li>
                        <p>
                ...
                <ul>
                    <li>By email: devitizen@gmail.com</li>
                </ul>
            </Container>
        </Container>
    );
